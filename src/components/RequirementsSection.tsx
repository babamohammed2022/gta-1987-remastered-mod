...
return ( <section id="requirements" className="py-20 px-4"> <div className="max-w-6xl mx-auto"> <div className="text-center mb-12"> <h2 className="text-4xl md:text-5xl font-heading font-bold mb-4 text-gradient">
Requirements </h2> <p className="text-xl text-muted-foreground">
Everything you need to run GTA San Andreas Stories smoothly. </p> </div>
        ...
        <CardContent>
          <div className="mb-6 p-4 bg-secondary/10 border border-secondary/20 rounded-lg">
            <p className="text-sm text-muted-foreground">
              <strong>Important:</strong> GTA San Andreas Stories already includes all
              required dependencies for a standard installation.
              The storyline is built on DYOM 8.1, which is already included
              and pre-configured within the modpack.
              <br /><br />
              The downloads listed below are provided mainly for debugging,
              troubleshooting, manual updates, compatibility testing, or for
              users who wish to download individual components separately.
              <br /><br />
              If a dependency becomes corrupted, is accidentally removed,
              or fails to install correctly, you can download the latest
              version directly from its official source using the links below.
            </p>
          </div>
          ...
          <p className="mt-6 text-sm text-center text-muted-foreground">
            ...
            Report any issues on Discord for troubleshooting,
            compatibility assistance, or future adjustments.
          </p>
          ...
          <div className="mt-6 text-center">
            ...
            >
              No additional downloads are required for standard installation.
            </Badge>
          </div>
        </CardContent>
      </Card>
